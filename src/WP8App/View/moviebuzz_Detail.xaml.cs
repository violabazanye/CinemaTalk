...
{
    /// <summary>
    /// Phone application page for moviebuzz_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class moviebuzz_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for moviebuzz_Detail and all its components.
        /// </summary>
        public moviebuzz_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramamoviebuzz_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramamoviebuzz_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramamoviebuzz_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramamoviebuzz_Detail(Panoramamoviebuzz_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramamoviebuzz_Detail(PanoramaItem panoramaItem)        
        {
