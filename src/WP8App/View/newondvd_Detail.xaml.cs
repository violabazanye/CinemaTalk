...
{
    /// <summary>
    /// Phone application page for newondvd_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class newondvd_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for newondvd_Detail and all its components.
        /// </summary>
        public newondvd_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramanewondvd_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramanewondvd_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramanewondvd_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramanewondvd_Detail(Panoramanewondvd_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramanewondvd_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Inewondvd_dvdDataSource>();
				AddHomeAppBarButton();
				...
				((IViewModels.Inewondvd_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
