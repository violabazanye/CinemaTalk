...
{
    /// <summary>
    /// Phone application page for intheaters_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class intheaters_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for intheaters_Detail and all its components.
        /// </summary>
        public intheaters_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramaintheaters_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramaintheaters_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaintheaters_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaintheaters_Detail(Panoramaintheaters_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaintheaters_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Iintheaters_openingMoviesDataSource>();
				AddHomeAppBarButton();
				...
				((IViewModels.Iintheaters_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
