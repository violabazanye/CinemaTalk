...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.Istart_MenuViewModel), "/View/start_Menu.xaml" },
            { typeof(IViewModels.Iintheaters_NewsViewModel), "/View/intheaters_News.xaml" },
            { typeof(IViewModels.Iintheaters_DetailViewModel), "/View/intheaters_Detail.xaml" },
            { typeof(IViewModels.Imovieoftheweek_NewsViewModel), "/View/movieoftheweek_News.xaml" },
            { typeof(IViewModels.Imovieoftheweek_DetailViewModel), "/View/movieoftheweek_Detail.xaml" },
            { typeof(IViewModels.Imoviebuzz_NewsViewModel), "/View/moviebuzz_News.xaml" },
            { typeof(IViewModels.Imoviebuzz_DetailViewModel), "/View/moviebuzz_Detail.xaml" },
            { typeof(IViewModels.Inewondvd_NewsViewModel), "/View/newondvd_News.xaml" },
            { typeof(IViewModels.Inewondvd_DetailViewModel), "/View/newondvd_Detail.xaml" },
