...
namespace WPAppStudio.Repositories
{
    ...
    public class moviebuzz_reviewsDataSource : Imoviebuzz_reviewsDataSource 
    {
		...
		private const string RssUrl = "http://www.movies.com/rss-feeds/dave-white-reviews-rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="moviebuzz_reviewsDataSource" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public moviebuzz_reviewsDataSource(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.movies.com/rss-feeds/dave-white-reviews-rss), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("moviebuzz_reviewsDataSource", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("moviebuzz_reviewsDataSource");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.movies.com/rss-feeds/dave-white-reviews-rss), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
