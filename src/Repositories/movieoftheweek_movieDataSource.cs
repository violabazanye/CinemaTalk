...
namespace WPAppStudio.Repositories
{
    ...
    public class movieoftheweek_movieDataSource : Imovieoftheweek_movieDataSource 
    {
		...
		private const string RssUrl = "http://www.rottentomatoes.com/syndication/rss/movie_certified_fresh.xml";

        /// <summary>
        /// Initializes a new instance of the <see cref="movieoftheweek_movieDataSource" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public movieoftheweek_movieDataSource(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.rottentomatoes.com/syndication/rss/movie_certified_fresh.xml), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("movieoftheweek_movieDataSource", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("movieoftheweek_movieDataSource");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.rottentomatoes.com/syndication/rss/movie_certified_fresh.xml), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
